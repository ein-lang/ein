...
pub struct RecordFunctionPass {}

impl RecordFunctionPass {
    pub fn new() -> Self {
        Self {}
    }
...
mod tests {
    ...
    #[test]
    fn compile_record_element_functions() {
        ...
        assert_eq!(
            RecordFunctionPass::new().compile(&Module::from_definitions_and_type_definitions(
